...
if __name__ == "__main__":
    ...
    parser.add_argument("-a", "--audio", dest="audio_file", required=True, help="音频文件的路径 (例如 my_vlog.mp3)。")
    parser.add_argument("-s", "--subtitles", dest="subtitle_option", nargs='?', const=True, default=None,
                        help="烧录字幕。若只提供此参数而不带路径，则自动生成字幕；若提供文件路径，则使用该文件。")
